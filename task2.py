...
print("Max speed: %.1f MPH %.1f KPM"%(max_speed_in_km,max_speed_in_miles))
print("Min speed: %.1f MPH %.1f KPM"%(min_speed_in_km,min_speed_in_miles))
print("Avg speed: %.1f MPH %.1f KPM"%(avg_speed_in_km,avg_speed_in_miles))
